...
5. 如果用户关心“主营业务、收入来自谁、市场多大、竞争多大、未来走势”，跑业务分析报告命令：
   - `.venv/bin/seed build-finance-business-analysis-report library/distilled/<slug>.finance-digest.news-context.json`
   - 命令会生成：
