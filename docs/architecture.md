...
| UP 主页与名单蒸馏 | `seed distill-up-list`, `seed build-up-homepage` | `src/seed/cli.py` | `library/reports/*.up-comparison.html`, `library/reports/*.up-homepage.html`，可链接 finance digest / finance-news-report |
